...
This project is hosted on Vercel, a cloud platform for serverless deployment. You can access the live website at https://NewsDay.vercel.app/.

## API Used

This project fetches the latest news articles from the NDTV API, which can be found at https://NewsDay.vercel.app/. The API provides news articles in JSON format.
...
```bash
    $ git clone https://github.com/RemoDeveloper/news-website.git
```
